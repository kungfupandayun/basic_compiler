...
public class TestMultiplyAdvanced {
    ...
    class MultiplyMock extends Multiply{
    	public MultiplyMock(AbstractExpr leftOperand, AbstractExpr rightOperand) {
    ...
    @Mock
    MultiplyMock multiply =mock(MultiplyMock.class);
    ...
    @Test
    public void testMultiplyName() throws ContextualError {
      multiply  = new MultiplyMock(floatexpr1, intexpr1);
       assertEquals("*",multiply.getOperatorName());
