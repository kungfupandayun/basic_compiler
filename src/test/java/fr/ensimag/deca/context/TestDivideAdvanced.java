...
public class TestDivideAdvanced {
    ...
    class DivideMock extends Divide{
    	public DivideMock(AbstractExpr leftOperand, AbstractExpr rightOperand) {
    ...
    @Mock
    DivideMock divide =mock(DivideMock.class); 
    ...
    @Test
    public void testDivideName() throws ContextualError {
    	divide  = new DivideMock(floatexpr1, intexpr1);
       assertEquals("/",divide.getOperatorName());
