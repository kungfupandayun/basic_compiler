...
public class TestEqualAdvanced {
    ...
    class EqualsMock extends Equals{
    	public EqualsMock(AbstractExpr leftOperand, AbstractExpr rightOperand) {
    ...
    @Mock
    EqualsMock equals =mock(EqualsMock.class);
    ...
    @Test
    public void testEqualsName() throws ContextualError {
      equals  = new EqualsMock(floatexpr1, intexpr1);
       assertEquals("==",equals.getOperatorName());
