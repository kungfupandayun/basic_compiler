...
public class TestPlusAdvanced {
    ...
    class PlusMock extends Plus{
    	public PlusMock(AbstractExpr leftOperand, AbstractExpr rightOperand) {
    ...
    @Mock
    PlusMock plus =mock(PlusMock.class);
    ...
    @Test
    public void testPlusName() throws ContextualError {
      plus  = new PlusMock(floatexpr1, intexpr1);
