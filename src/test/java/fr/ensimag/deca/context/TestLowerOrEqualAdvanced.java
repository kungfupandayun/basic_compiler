...
public class TestLowerOrEqualAdvanced {
    ...
    class LowerOrEqualMock extends LowerOrEqual{
    	public LowerOrEqualMock(AbstractExpr leftOperand, AbstractExpr rightOperand) {
    ...
    @Mock
    LowerOrEqualMock g =mock(LowerOrEqualMock.class);
    ...
    @Test
    public void testLowerOrEqualName() throws ContextualError {
       g = new LowerOrEqualMock(floatexpr1, intexpr1);
