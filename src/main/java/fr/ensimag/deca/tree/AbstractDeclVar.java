...
public abstract class AbstractDeclVar extends Tree {
  ...
  /**
   * Generate assembly code for the variable.
   * 
   * @param compiler
   */
    protected abstract void codeGenDeclVar(DecacCompiler compiler);
    /**
     * Generate assembly code for the variable of the method.
     * 
     * @param compiler
     */
    public abstract void codeGenDeclVarMethod(DecacCompiler compiler);
}
