...
public abstract class Tree {
    ...
    /**An attribut to save the location of the expression or symbol*/
    private Location location;

    /*
    private static EnvironmentType environmentType;

    public void initiEnvType(Location location){
      this.environmentType = new EnvironmentType(location);
    }

    public void add(TypeDefinition typeDef){
      this.environmentType.addTypeDefinition(typeDef);
    }
	*/
    
    /**
     *
     * @return location of an expression or symbol
     */
    public Location getLocation() {
        return location;
    }

    /** Set location of an expression or symbol*/
